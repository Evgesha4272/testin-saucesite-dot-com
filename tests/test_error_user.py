...
def test_error_user(set_up):
    ...
    # # Call method authorization_error from login_page.py
    login_p = LoginPage(driver)
    login_p.authorization_error()

    # Call method chose_product from main_page.py
    main_p = MainPage(driver)
    main_p.chose_product_error_user()
